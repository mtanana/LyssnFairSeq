...
python ../../train.py /lyssn/datasets/asr/asraug2020fixedlength10/ --save-dir /lyssn/temp/asr/wav2vec/asraug20202.3/ --fp16 \
--reset-dataloader \
--post-process letter --valid-subset valid  --no-epoch-checkpoints --best-checkpoint-metric wer --num-workers 15 \
--max-update 4050000 --sentence-avg --task audio_pretraining --arch wav2vec_ctc --w2v-path /lyssn/datasets/asr/test2/wav2vec_vox.pt \
...
--decay-steps 2450000 --final-lr-scale 0.05 --final-dropout 0.0 --dropout 0.0 --activation-dropout 0.1 --criterion ctc \
...
--tensorboard-logdir /lyssn/temp/asr/wav2vec/test2/tensorboardaug2020v2.3 \
